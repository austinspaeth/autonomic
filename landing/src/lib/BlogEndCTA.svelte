<script lang="ts">
  ...
  import { pricing, priceLabel, appStoreUrl } from './site';
</script>
...
<div class="article-cta">
  ...
  <a class="btn btn-primary btn-lg btn-appstore" href={appStoreUrl} aria-label="Download Autonomic on the App Store">
