...
<div class="side-stack">
  ...
  <section class="side-card side-get">
    ...
    <div class="side-phone-stage" aria-hidden="true">
      <div class="sg-orbit sg-orbit-a"><span class="dot" style="background:#2ee06a"></span>HRV 42 ms</div>
      <div class="sg-orbit sg-orbit-b"><span class="dot" style="background:#16a34a"></span>▲ 10 vs 7d</div>
      <div class="sg-orbit sg-orbit-c"><span class="dot" style="background:var(--accent)"></span>2h 50m left</div>
      <div class="side-phone">
      <div class="sg-scr"><JournalMock zoom={164 / 402} height={980} /></div>
      </div>
    </div>
