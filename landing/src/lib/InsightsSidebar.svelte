<script lang="ts">
  ...
  import { articleHref, formatDate, BRAND_POLYLINE, PILLARS, PILLAR_LABELS, appStoreUrl, playStoreUrl } from './site';
...
<div class="side-stack">
  ...
  <section class="side-card side-get">
    ...
    <a class="dl-ios-badge" href={appStoreUrl} data-dl-store="ios" aria-label="Download on the App Store">
    ...
    <a class="dl-ios-badge" href={playStoreUrl} data-dl-store="android" aria-label="Get it on Google Play">
