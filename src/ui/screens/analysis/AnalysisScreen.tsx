...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    sections: [acAllHrv, acStructuredHrv, acUnstructuredHrv, acMorning, acEvening],
  },
  {
    id: 'vitals',
    icon: 'heart',
  ...
  },
  {
    ...
    sections: [acOrthostatic, acExtremeEvents],
  },
  {
    id: 'sleep',
    icon: 'moon',
  ...
  },
  {
    ...
    sections: [acActivity, acExerciseProgression],
  },
  {
    id: 'food',
    icon: 'utensils',
