...
function GradientBorderCard({ color, trigger, corner = 'topLeft', glow: wash, flash, style, children }: { color: string | null; trigger?: string; corner?: 'topLeft' | 'topRight'; glow?: boolean | number; flash?: boolean; style?: any; children: React.ReactNode }) {
  const p = usePalette();
