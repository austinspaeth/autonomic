...
export const REPORT_CARDS: ReportCard[] = [
  { id: 'overall', icon: 'chart', title: 'Overall Health Summary', desc: 'All metrics for the period with trends and recommendations.', sections: ['hrv', 'bp', 'rhr', 'sleep', 'activities', 'triggers', 'meds', 'supplements', 'symptoms', 'orthostatic', 'scores', 'cleanDays'], focus: 'Provide a comprehensive analysis of all health metrics for this period and how they interact.', instructions: 'Cover all systems and how they interact. Identify what is working and what is not.' },
  ...
  { id: 'doctor', icon: 'clipboard', title: 'Medical Summary For Doctor', desc: 'Structured summary for healthcare providers.', sections: ['hrv', 'bp', 'rhr', 'sleep', 'symptoms', 'orthostatic', 'meds', 'supplements', 'scores'], focus: 'Generate a structured medical summary suitable for sharing with providers.', instructions: 'Summarize recent metrics/trends, persisting symptoms, and notable concerns from the data, plus questions for a physician. Professional tone; do not assert diagnoses not present in the data.' },
];
