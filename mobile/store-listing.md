...
• Reads & writes Apple Health (HRV, resting HR, sleep, blood pressure) only when you ask it to
...
2. NEW watch panel: brand background, watch mockups (stand test + complication), caption "POTS testing on your wrist"
3. NEW handoff shot: phone reading-summary card when a watch test arrives (HR series chart, graded delta)
